...
static const SymptomRule g_symptom_dict[] = {
    // 1. 危急症状（1000分，直接推荐急诊科）
    {"昏迷", 1000, "急诊科"}, {"休克", 1000, "急诊科"}, {"呼吸困难", 1000, "急诊科"}, {"窒息", 1000, "急诊科"},
    {"大出血", 1000, "急诊科"}, {"心跳停止", 1000, "急诊科"}, {"抽搐", 1000, "急诊科"}, {"意识丧失", 1000, "急诊科"},
    {"胸痛", 1000, "急诊科"}, {"腹痛", 1000, "急诊科"}, {"剧烈头痛", 1000, "急诊科"}, {"中风", 1000, "急诊科"},
    {"严重创伤", 1000, "急诊科"}, {"农药中毒", 1000, "急诊科"},
    
    // 2. 明确症状（100分）
    {"胸痛", 100, "心血管内科"}, {"胸闷气短", 100, "心血管内科"}, {"心悸", 100, "心血管内科"}, {"心慌", 100, "心血管内科"},
    {"咳嗽", 100, "呼吸内科"}, {"咳血", 100, "呼吸内科"}, {"咯血", 100, "呼吸内科"}, {"气喘", 100, "呼吸内科"},
    {"哮喘", 100, "呼吸内科"}, {"发烧", 100, "呼吸内科"}, {"感冒", 100, "呼吸内科"},
    {"皮疹", 100, "皮肤科"}, {"皮肤瘙痒", 100, "皮肤科"}, {"耳鸣", 100, "耳鼻喉科"}, {"耳聋", 100, "耳鼻喉科"},
    {"关节炎", 100, "风湿科"}, {"关节痛", 100, "风湿科"}, {"僵硬", 100, "风湿科"}, {"肌肉酸痛", 100, "风湿科"},
    {"视力下降", 100, "眼科"}, {"视力模糊", 100, "眼科"},
    {"鼻炎", 100, "耳鼻喉科"}, {"咽炎", 100, "耳鼻喉科"}, {"喉咙痛", 100, "耳鼻喉科"}, {"扁桃体", 100, "耳鼻喉科"},
    {"鼻塞", 100, "耳鼻喉科"}, {"流涕", 100, "耳鼻喉科"}, {"头晕", 100, "耳鼻喉科"}, {"眩晕", 100, "耳鼻喉科"},
    {"月经不调", 100, "妇产科"}, {"痛经", 100, "妇产科"}, {"白带异常", 100, "妇产科"}, {"不孕", 100, "生殖科"},
    
    // 3. 普通/常见症状（50分）
    {"头晕头痛", 50, "神经内科"}, {"恶心", 50, "神经内科"}, {"头痛", 50, "神经内科"}, {"头晕", 50, "神经内科"},
    {"高血压", 50, "心血管内科"}, {"血压高", 50, "心血管内科"}, {"心律不齐", 50, "心血管内科"}, {"心跳过速", 50, "心血管内科"},
    {"腹部不适", 50, "消化内科"}, {"腹泻", 50, "消化内科"}, {"食欲不振", 50, "消化内科"}, {"体重下降", 50, "消化内科"},
    {"肾结石", 50, "泌尿外科"}, {"腰痛", 50, "泌尿外科"}, {"颈椎疼痛", 50, "骨科"}, {"黄疸", 50, "消化内科"},
    {"尿频", 50, "泌尿外科"}, {"尿急", 50, "泌尿外科"}, {"尿痛", 50, "泌尿外科"}, {"排尿困难", 50, "泌尿外科"},
    {"甲状腺", 50, "内分泌科"}, {"甲亢", 50, "内分泌科"}, {"甲减", 50, "内分泌科"}, {"糖尿病", 50, "内分泌科"},
    {"乳腺增生", 50, "乳腺外科"}, {"乳房胀痛", 50, "乳腺外科"}, {"乳头溢液", 50, "乳腺外科"},
    {"牙痛", 50, "口腔科"}, {"牙龈痛", 50, "口腔科"}, {"牙周炎", 50, "口腔科"}, {"口腔溃疡", 50, "口腔科"},
    
    // 4. 轻微/辅助症状（10分）
    {"失眠", 10, "神经内科"}, {"多梦", 10, "神经内科"}, {"焦虑", 10, "神经内科"}, {"抑郁", 10, "神经内科"},
    {"儿童", 10, "儿科"}, {"小儿", 10, "儿科"}, {"小孩", 10, "儿科"}, {"婴儿", 10, "儿科"},
    {"皮肤干燥", 10, "皮肤科"}, {"脱皮", 10, "皮肤科"}, {"皮肤过敏", 10, "皮肤科"}, {"皮肤红肿", 10, "皮肤科"},
    {"关节酸痛", 10, "骨科"}, {"肌肉拉伤", 10, "骨科"}, {"腰背酸痛", 10, "骨科"}, {"肩周炎", 10, "骨科"},
    {"眼睛干涩", 10, "眼科"}, {"眼睛疲劳", 10, "眼科"}, {"视力模糊", 10, "眼科"}, {"眼睛红肿", 10, "眼科"},
    {"妇科炎症", 10, "妇产科"}, {"阴道炎", 10, "妇产科"}, {"宫颈炎", 10, "妇产科"}, {"盆腔炎", 10, "妇产科"},
    {"打鼾", 10, "呼吸内科"}, {"睡眠呼吸暂停", 10, "呼吸内科"}, {"胸闷气短", 10, "呼吸内科"}, {"活动后气喘", 10, "呼吸内科"}
};
...
)
{
    ...
    if (patient == NULL)
    {
        printf("[ERROR] 患者信息不存在，无法预约！\n");
        return 0;
    }

    if (patient->is_blacklisted != 0)
    {
        printf("[ERROR] 该患者当前存在爽约/恶意欠费记录，暂时无法预约，请前往服务台联系工作人员处理！\n");
        return 0;
    }

    if (patient->emergency_debt > 0)
    {
        printf("[ERROR] 该患者存在急诊欠费 %.2f 元，暂时无法预约，请先补缴欠费后再试！\n", patient->emergency_debt);
        return 0;
    }

    if (patient->status == STATUS_NO_SHOW)
    {
        printf("[ERROR] 该患者当前预约已过号/爽约，暂时无法再次预约，请前往服务台处理！\n");
        return 0;
    }
    ...
    {
        printf("[ERROR] 该患者当前存在未完成的就诊流程，无法重复预约！\n");
...
)
{
    ...
    if (existing_patient != NULL)
    {
        ...
        {
            printf("[警告] 该身份证号对应的患者在黑名单中，请使用原患者信息或联系工作人员！\n");
        }
        else
        {
            printf("[警告] 该身份证号已存在，请不要重复建档！\n");
        }
        return NULL;
    }
    ...
    {
        printf("[急诊提示] 症状符合急诊特征，已标记为危重患者！\n");
    }
    
    if (is_night_shift())
    {
        printf("[夜间模式] 当前为夜间时段，普通门诊关闭，系统将为您自动分配到急诊科。\n");
        // 强制将目标科室设为急诊科
        if (target_dept != NULL && strlen(target_dept) > 0 && strcmp(target_dept, "急诊科") != 0)
        {
            printf("[夜间模式] 您选择的目标科室: %s，夜间已关闭，系统将患者分配至急诊科。\n", target_dept);
        }
        // 只修改实际科室，不修改目标科室
        ...
        if (symptom != NULL && strlen(symptom) > 0)
        {
            printf("智能导诊提示：根据症状描述，系统推荐科室为：%s\n", recommended_dept);
        }
        else
        {
            printf("提示：未填写症状描述，系统不进行智能分诊。\n");
        }
    ...
    if (strcmp(recommended_dept, "急诊科") == 0)
    {
        ...
        printf("[急诊提示] 患者症状符合急诊特征，已标记为急诊绿色通道患者！\n");
    }
    ...
    printf("当前状态：已建档，尚未预约或挂号。\n");
    printf("提示：如需预约，请进入预约登记；如需当天就诊，请进入现场挂号。\n");
